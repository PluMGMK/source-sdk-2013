...
inline void ComplexMultiply( const ComplexNumber& a, ComplexNumber& b, ComplexNumber& c )
{
	Assert( a.IsValid() && IsFinite(b) );
	//Standard binomial multiplication
...
inline void ComplexDivide( const ComplexNumber& a, ComplexNumber& b, ComplexNumber& c )
{
	Assert( a.IsValid() );
